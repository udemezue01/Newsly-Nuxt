<template>
    ...
    <div class="w-full max-w-lg p-6 m-auto mx-auto dark:bg-gray-800 font-body">
       ...
       <div class="">
           ...
           <label for="Images" class="block text-sm text-gray-800 dark:text-gray-200">Featured Image</label>

           <input  type="file" @change="uploadFile" class="block w-full px-6 py-4 mt-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
       </div>
