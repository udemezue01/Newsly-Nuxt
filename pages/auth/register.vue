    ...
    <div class="w-full max-w-lg p-6 m-auto mx-auto dark:bg-gray-800 font-body">
        ...
        <form class="space-y-8">
            <div>
                ...
                <input v-model ="registerDetails.email" type="text" class="block w-full px-6 py-4 mt-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
            </div>
            ...
            <div class="">
                ...
                <input v-model ="registerDetails.password"  type="password" class="block w-full px-6 py-4 mt-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
            </div>
